#ifndef APP2_LOWERTHRESBLOCK_H
#define APP2_LOWERTHRESBLOCK_H
...
class APP2_lowerthresblock : public APP2_customblock {
private:
...
public:
    ...
    APP2_lowerthresblock(QGraphicsScene * parent, float thres);
